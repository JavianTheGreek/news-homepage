...
const HandleDesktopImage = ( {isDesktop} ) => (
    <div className="">
        <img src={DesktopImage} alt="/" className='max-lg:hidden' />
    </div>
);
    ...
    <div className="md:mt-6">
        <div className="border-b-dark-grayish-blue border">
            <div className='text-off-white my-2'>
                <h3 className='font-bold my-4 text-2xl md:text-lg hover:text-soft-orange duration-300 ease-in-out cursor-pointer'>{title}</h3>
